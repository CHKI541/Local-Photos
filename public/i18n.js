...
const TRANSLATIONS = {
    es: {
        ...
        settings_scan_startup_title: 'Escanear las carpetas al abrir la app',
        settings_scan_startup_desc: 'Si está apagado, la app abre al instante usando lo ya indexado y no vuelve a recorrer las carpetas cada vez. Para sumar fotos nuevas, usá "Guardar y Escanear Ahora".',
        settings_hebrew_title: 'Fecha hebrea',
        settings_hebrew_show_title: 'Mostrar la fecha hebrea en las imágenes',
        settings_hebrew_show_desc: 'Muestra también la fecha hebrea en el panel de información del visor.',
        settings_hebrew_sort_title: 'Ordenar la línea de tiempo por fecha hebrea',
        settings_hebrew_sort_desc: 'Los encabezados de fecha de la cuadrícula se muestran en el calendario hebreo.',
        settings_hebrew_memories_title: 'Recuerdos según la fecha hebrea',
        settings_hebrew_memories_desc: 'La tira de "Recuerdos" compara el mismo día del calendario hebreo en años anteriores.',
        settings_update_title: 'Versión y Actualizaciones',
        settings_update_description: 'Comprueba si hay una nueva versión disponible en GitHub.',
        settings_check_update_button: 'Buscar actualización',
        update_checking: 'Buscando actualizaciones...',
        update_already_latest: '¡Ya tienes la última versión instalada (v{version})!',
        update_available: '¡Nueva versión disponible: v{version}!',
        update_downloading: 'Descargando actualización...',
        update_btn_install: 'Descargar e instalar automáticamente',
        update_status_downloading: 'Descargando actualización ({percent}%)...',
        update_status_ready: 'Instalación lista. Iniciando instalador...',
        update_error: 'No se pudo verificar la actualización. Intenta más tarde.',
        update_no_releases: 'No hay versiones publicadas aún en GitHub.',
    ...
    en: {
        ...
        settings_scan_startup_title: 'Scan folders when the app opens',
        settings_scan_startup_desc: 'If off, the app opens instantly using what is already indexed and will not re-scan your folders every time. To add new photos, use "Save and Scan Now".',
        settings_hebrew_title: 'Hebrew date',
        settings_hebrew_show_title: 'Show the Hebrew date on images',
        settings_hebrew_show_desc: 'Also shows the Hebrew date in the viewer info panel.',
        settings_hebrew_sort_title: 'Order the timeline by Hebrew date',
        settings_hebrew_sort_desc: 'The grid date headers are shown using the Hebrew calendar.',
        settings_hebrew_memories_title: 'Memories by Hebrew date',
        settings_hebrew_memories_desc: 'The "Memories" strip compares the same day of the Hebrew calendar in previous years.',
        settings_update_title: 'Version & Updates',
        settings_update_description: 'Check if a new version is available on GitHub.',
        settings_check_update_button: 'Check for updates',
        ...
        update_btn_install: 'Download and install automatically',
        update_status_downloading: 'Downloading update ({percent}%)...',
        update_status_ready: 'Installation ready. Launching installer...',
        update_error: 'Could not check for updates. Try again later.',
        update_no_releases: 'No releases published yet on GitHub.',
    ...
    he: {
        ...
        settings_scan_startup_title: 'סריקת התיקיות בעת פתיחת האפליקציה',
        settings_scan_startup_desc: 'אם כבוי, האפליקציה נפתחת מיד עם מה שכבר נאנדקס ולא סורקת שוב את התיקיות בכל פעם. כדי להוסיף תמונות חדשות, השתמשו ב"שמירה וסריקה עכשיו".',
        settings_hebrew_title: 'תאריך עברי',
        settings_hebrew_show_title: 'הצגת התאריך העברי על התמונות',
        settings_hebrew_show_desc: 'מציג גם את התאריך העברי בחלונית המידע של המציג.',
        settings_hebrew_sort_title: 'סידור ציר הזמן לפי התאריך העברי',
        settings_hebrew_sort_desc: 'כותרות התאריך ברשת מוצגות לפי לוח השנה העברי.',
        settings_hebrew_memories_title: 'זכרונות לפי התאריך העברי',
        settings_hebrew_memories_desc: 'רצועת ה"זכרונות" משווה את אותו יום בלוח השנה העברי בשנים קודמות.',
        settings_update_title: 'גרסה ועדכונים',
        settings_update_description: 'בדוק אם קיימת גרסה חדשה ב-GitHub.',
        settings_check_update_button: 'חפש עדכונים',
        update_checking: 'מחפש עדכונים...',
        update_already_latest: 'אתה כבר משתמש בגרסה העדכנית ביותר (v{version})!',
        update_available: 'גרסה חדשה זמינה: v{version}!',
        update_downloading: 'מוריד עדכון...',
        update_btn_install: 'הורד והתקן באופן אוטומטי',
        update_status_downloading: 'מוריד עדכון ({percent}%)...',
        update_status_ready: 'ההתקנה מוכנה. מפעיל את ההתקנה...',
        update_error: 'לא ניתן היה לבדוק עדכונים. נסה שוב מאוחר יותר.',
        update_no_releases: 'עדיין אין גרסאות מפורסמות ב-GitHub.',
